...
export default function PCCharacterCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setGearPoints(initialValues.gearPoints);
    setGearPointsMax(initialValues.gearPointsMax);
    setErrors({});
  };
  const validations = {
    name: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new PCCharacter(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "PCCharacterCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
